  ...
  def calculate_season_statistics(teams)
    teams.each do |team|
      team.preseason_games.keys.each do |season|
        team.preseason_win_percentage[season] = team.preseason_wins[season].to_f / team.preseason_games[season].to_f * 100.0
      ...
      team.regular_games.keys.each do |season|
        team.regular_win_percentage[season] = team.regular_wins[season].to_f / team.regular_games[season].to_f * 100.0
